...
for(m in 1:1){
  ...
  readr::write_rds(x=post[[m]], path = file.path(devtools::package_file(), "output", "stan_samples", params$model, params$flag, glue::glue("data_post-{m}.rds")))
