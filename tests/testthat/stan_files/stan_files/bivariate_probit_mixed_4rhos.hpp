...
namespace model_bivariate_probit_mixed_4rhos_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bivariate_probit_mixed_4rhos");
    ...
    reader.add_event(49, 2, "restart", "model_bivariate_probit_mixed_4rhos");
    reader.add_event(158, 111, "end", "model_bivariate_probit_mixed_4rhos");
    return reader;
}
...
#include <meta_header.hpp>
 class model_bivariate_probit_mixed_4rhos : public prob_grad {
private:
    int n;
    int n_condition;
    int n_subject;
...
public:
    model_bivariate_probit_mixed_4rhos(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bivariate_probit_mixed_4rhos_namespace::model_bivariate_probit_mixed_4rhos";
        ...
        try {
            ...
            validate_non_negative_index("condition_omega", "n_condition", n_condition);
            num_params_r__ += ((D * (D - 1)) / 2) * n_condition;
    ...
    ~model_bivariate_probit_mixed_4rhos() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("condition_omega", "D", D);
        validate_non_negative_index("condition_omega", "D", D);
        context__.validate_dims("initialization", "condition_omega", "matrix_d", context__.to_vec(n_condition,D,D));
        std::vector<matrix_d> condition_omega(n_condition,matrix_d(static_cast<Eigen::VectorXd::Index>(D),static_cast<Eigen::VectorXd::Index>(D)));
        for (int j2__ = 0U; j2__ < D; ++j2__)
            for (int j1__ = 0U; j1__ < D; ++j1__)
                for (int i0__ = 0U; i0__ < n_condition; ++i0__)
                    condition_omega[i0__](j1__,j2__) = vals_r__[pos__++];
        for (int i0__ = 0U; i0__ < n_condition; ++i0__)
            try {
            writer__.corr_matrix_unconstrain(condition_omega[i0__]);
        } catch (const std::exception& e) { 
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<T__,Eigen::Dynamic,Eigen::Dynamic> > condition_omega;
            size_t dim_condition_omega_0__ = n_condition;
            condition_omega.reserve(dim_condition_omega_0__);
            for (size_t k_0__ = 0; k_0__ < dim_condition_omega_0__; ++k_0__) {
                if (jacobian__)
                    condition_omega.push_back(in__.corr_matrix_constrain(D,lp__));
                else
                    condition_omega.push_back(in__.corr_matrix_constrain(D));
            }
            ...
            for (int cond = 1; cond <= n_condition; ++cond) {

                current_statement_begin__ = 133;
                lp_accum__.add(lkj_corr_log<propto__>(get_base1(condition_omega,cond,"condition_omega",1), get_base1(priors,6,"priors",1)));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "model_bivariate_probit_mixed_4rhos_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        vector<matrix_d> condition_omega;
        size_t dim_condition_omega_0__ = n_condition;
        for (size_t k_0__ = 0; k_0__ < dim_condition_omega_0__; ++k_0__) {
            condition_omega.push_back(in__.corr_matrix_constrain(D));
        }
        ...
        matrix_d item_L = in__.cholesky_corr_constrain(D);
            for (int k_2__ = 0; k_2__ < D; ++k_2__) {
                for (int k_1__ = 0; k_1__ < D; ++k_1__) {
                    for (int k_0__ = 0; k_0__ < n_condition; ++k_0__) {
                    vars__.push_back(condition_omega[k_0__](k_1__, k_2__));
                    }
                }
            }
        ...
        try {
            ...
            validate_non_negative_index("condition_rho", "n_condition", n_condition);
            vector_d condition_rho(static_cast<Eigen::VectorXd::Index>(n_condition));
            ...
            for (int cond = 1; cond <= n_condition; ++cond) {
                ...
                stan::math::assign(get_base1_lhs(condition_rho,cond,"condition_rho",1), get_base1(get_base1(condition_omega,cond,"condition_omega",1),1,2,"condition_omega",2));
            }
            {
        ...
        vars__.push_back(item_rho);
            for (int k_0__ = 0; k_0__ < n_condition; ++k_0__) {
            vars__.push_back(condition_rho[k_0__]);
            }
    ...
    static std::string model_name() {
        return "model_bivariate_probit_mixed_4rhos";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_2__ = 1; k_2__ <= D; ++k_2__) {
            for (int k_1__ = 1; k_1__ <= D; ++k_1__) {
                for (int k_0__ = 1; k_0__ <= n_condition; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "condition_omega" << '.' << k_0__ << '.' << k_1__ << '.' << k_2__;
        ...
        for (int k_0__ = 1; k_0__ <= n_condition; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "condition_rho" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
    }
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
                                   ...
                                   bool include_gqs__ = true) const {
        std::stringstream param_name_stream__;
        for (int k_1__ = 1; k_1__ <= ((D * (D - 1)) / 2); ++k_1__) {
            for (int k_0__ = 1; k_0__ <= n_condition; ++k_0__) {
                param_name_stream__.str(std::string());
...
typedef model_bivariate_probit_mixed_4rhos_namespace::model_bivariate_probit_mixed_4rhos stan_model;
