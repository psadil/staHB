...
#include "bivariate_probit_mixed_onec_mo_nonc.hpp"

RCPP_MODULE(stan_fit4bivariate_probit_mixed_onec_mo_nonc_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_bivariate_probit_mixed_onec_mo_nonc")
