...
estimated_model <- sampling(readRDS(file.path(devtools::package_file(), "stan", paste0(params$model, ".rds"))), 
                            data = stan_data, 
                            iter = params$iter,
...
readr::write_rds(x=estimated_model, path = file.path(devtools::package_file(), "output", "data", params$model, params$flag, "data.rds"))
