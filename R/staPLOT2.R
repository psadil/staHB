staPLOT2 <- function (data, vars=c(1,2), groups=NULL, grouplabels=NULL, axislabels=c("DV1","DV2"),
...
p=ggplot(data=df, aes(x=x, y=y)) +
  ...
  geom_errorbar(aes(ymin = y-cy, ymax = y+cy), color="black", width = 0) +
  geom_errorbarh(aes(xmin = x-cx, xmax = x+cx), color="black", height = 0)
